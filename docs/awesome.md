...
<div align="center">
    ...
    <p>A list of Awesome resources related to DevSecOps, Software Development and Electrical Engineering which I have either experience, interested to learn</p>
    <p>or use as reference based on main <a href="https://awesome.re"><code>Awesome</code></a> list.</p>
</div>
